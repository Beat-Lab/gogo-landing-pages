export const Icons = {
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 flex-shrink-0 fill-neutral-700 hs-tab-active:fill-purple-300 dark:fill-neutral-300 dark:hs-tab-active:fill-purple-300 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
    ...
    paths: [
      {
        ...
        class:
          "fill-current text-neutral-500 transition duration-300 group-hover:text-purple-400 group-hover:dark:text-purple-400",
      },
    ],
    width: 24,
    height: 24,
  ...
  arrowLeftStatic: {
    ...
    class: "size-4 -scale-100 flex-shrink-0",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  quotation: {
    ...
    class:
      "h-10 w-10 opacity-[.4]  transform text-black dark:text-white",
    width: 16,
    height: 16,
    viewBox: "0 0 16 16",
    fill: "currentColor",
